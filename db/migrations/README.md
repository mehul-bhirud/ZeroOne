...
On a clean throwaway database, run `psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f db/migrations/verify_003_constraints.sql` after applying the migrations. The verifier rolls back its fixtures after checking every invariant.
